...
namespace SqlBob
{
    ...
    public abstract class Join : SqlStatement
    {
        ...
        public static InnerJoin Inner(object expression) => new InnerJoin(expression);

        /// <summary>Creates an LEFT (OUTER) JOIN.</summary>
        public static LeftJoin Left(object expression) => new LeftJoin(expression);

        /// <summary>Creates an RIGHT (OUTER) JOIN.</summary>
        public static RightJoin Right(object expression) => new RightJoin(expression);

        /// <summary>Creates an FULL OUTER JOIN.</summary>
        public static FullOutherJoin FullOuther(object expression) => new FullOutherJoin(expression);
    }
}
